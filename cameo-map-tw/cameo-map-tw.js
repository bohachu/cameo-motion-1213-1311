...
class CameoMapTw extends HTMLElement {
  ...
  parse_ary_chart_data(ary_data) {
    ...
    for (; i < ary_data[0].length; i++) {
      ...
      dic_data["description"] = ary_data[3][i];
      dic_data["industry"] = ary_data[4][i];
  ...
  async chart_render() {
    ...
    seriestw.name = "臺灣地圖";
    seriestw.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series5.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series4.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series3.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series1.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series2.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series7.geodataSource.url = "cameo-map-tw/taiwan.json";
    ...
    series6.geodataSource.url = "cameo-map-tw/taiwan.json";
